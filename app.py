...
def fetch_and_summarize(query, mode):
    ...
    elif "중학생" in mode: # ✅ "중등"에서 "중학생"으로 수정!
        role_name = "사춘기 아들을 둔 지적인 엄마"
        content_rule = """
        - 핵심 뉴스 3가지 선정.
        - [말투 중요]: 아나운서 말투 절대 금지! (~하단다, ~란다, ~인 것 같아)를 사용할 것.
        - [지식 전달]: 시사 용어를 그대로 쓰되, 아들이 이해하도록 한 문장으로 친절하게 풀이할 것.
        - 뉴스 사이사이에 "그리고 또 눈여겨볼 소식이 있어" 같은 전환 문장을 넣을 것.
        """
        start_msg = "엄마가 오늘 뉴스 들려줄게."
