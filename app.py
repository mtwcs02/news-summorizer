...
if "초등" in mode:
        # 🧒 초등학교 4학년 (11살) 모드: '진짜' 요약 버전
        role_name = "다정한 엄마"
        content_rule = """
        - [강력 규칙]: 뉴스 주제는 **무조건 딱 2개**만 고를 것. 
        - [분량 제한]: 전체 내용을 다 읽었을 때 **1분 이내(약 5~6문장)**로 끝낼 것.
        - [흐름]: "징검다리 문장:" 같은 머릿말은 절대 쓰지 말고, 자연스럽게 한 줄로 연결할 것.
        - [지식]: 설명(비유) 1문장 -> 현상 1문장 -> 용어 알려주기 1문장 순서로 딱딱 끊어서 말할 것.
        - [비유]: 한 뉴스당 비유는 딱 1개만 쓸 것. (비유가 많으면 오히려 헷갈림)
        """
